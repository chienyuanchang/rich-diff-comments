# Microsoft Edge Add-ons submission — v1.2.0
...
- **Zip:** `rdc-1.2.0.zip` (in this folder)
...
• Renamed to "Markdown PR Comments for GitHub" — same extension, clearer name for what it actually does. The new name will show up in your browser's extensions list and toolbar tooltip after this update.
• New icon to match — bold "M↓" mark in a speech bubble, on GitHub blue.
