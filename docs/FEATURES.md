...
- [ ] **GitHub-style comment box UX** — see "Native-style comment box" spec below. (Real gap because we render our own comment box; GitHub's native one stays in source-diff view.)
